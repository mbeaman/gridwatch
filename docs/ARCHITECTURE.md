...
pub fn hit(s: &Solved, pos: Position) -> Option<&Cell>;  pub fn unit_at(spec, body, mode, x, y) -> Option<(u8, u8)>;  pub fn unit_rect(spec, body, mode, at, size) -> Option<Rect>;  pub fn footprint_cycle(&[(u8,u8)], current) -> Option<(u8,u8)>;  pub fn focus_dir(…) -> Option<InstanceId>;   // unit_at ∘ solve is proptested (arc 4a)
