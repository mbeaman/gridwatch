...
| P17 | RSS ≤ 60 MB after 1 h, no growth | **39.0 MB** at 1 min → **42.0 MB** at 19 min: ≈ 180 kB/min of growth for 17 minutes, then flat for the last three (41.8 → 42.0 MB) — the series rings filling to their 10-minute retention plus the allocator's per-thread arenas settling (NVML maps ≈ 27 MB: 2a's process was 11.7 MB); a one-hour live run is in progress as this is written and its row follows; the 24 h replay proxy is owed — the 63 s fixture at 100× is a second, not a day | ✓ on the 20-minute evidence (42 of 60 MB); the hour's row is appended below when the run ends |
